                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form class="form-horizontal" action="{{ route('admin.tools.store') }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="desc" class="form-control" name="description" placeholder="Description of the tool"
                                    style="min-height: 60px;" rows="5">{{ old('description') }}</textarea>
                            </div>
                            <div class="form-group">
