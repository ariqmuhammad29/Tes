                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            ...
                                            <form action="{{ route('admin.sliders.destroy', $model->id) }}" method="post" class="d-inline delete-form">
                                                @csrf
                                                @method('delete')
                                                <a href="javascript:void(0);" class="dropdown-item" onclick="deleteConfirmation(event, this)">Delete</a>
                                            </form>
                                        </div>
                                    </div>
                                    <!-- /btn-group-->
...
<script>
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            element.closest('form').submit(); // Submit form nearest to the delete link
        }
    });
}
</script>
