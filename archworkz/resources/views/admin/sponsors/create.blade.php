            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="form-horizontal" action="{{ route('admin.sponsors.store') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="name">Name</label>
                            <div class="controls">
                                <input class="form-control" id="name" size="16" type="text" name="name" placeholder="Name of the sponsor">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                name="description"
                                placeholder="Description of the sponsor"
