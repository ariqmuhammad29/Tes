        ...
        <div class="card">
            <div class="card-body">
                ...
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <form class="form-horizontal" action="{{ route('admin.sponsors.update', $sponsor->id) }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="name" size="16" type="text" name="name"
                                placeholder="Name of the sponsor" value="{{ $sponsor->name }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea class="form-control" id="desc" name="description" cols="30" rows="10" style="min-height: 60px;"
                                placeholder="Description of the sponsor">{{ $sponsor->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
