    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('admin.about.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add
                    About</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($models as $key => $model)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                    <b class="thumbnail">{{ $model->title }}</b> <br>
                                </td>
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('admin.about.edit', $model->id) }}">Edit</a>
                                            <form action="{{ route('admin.about.destroy', $model->id) }}" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
